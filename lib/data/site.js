...
export const navItems = [
  ...
  { label: 'Dossier', href: '#resume' },
  { label: 'Connect', href: '#contact' },
];

// ---------------------------------------------------------------------------
// HUD chrome — decorative interface labels only. These describe the INTERFACE,
// never the person: no levels, XP, ranks, scores or skill percentages.
// ---------------------------------------------------------------------------
export const hud = {
  status: 'System Online',
  enterCue: 'Scroll to Explore',
};

// Hero HUD panels. Focus areas and values supplied by the owner — interface
// copy, not metrics (no levels, XP or percentages).
export const heroHud = {
  profile: {
    title: 'Player Profile',
    // Mirrors the four real engineering areas from `build.areas`.
    items: ['AI Systems', 'Full-Stack', 'Computer Vision', 'Data & Geospatial'],
  },
  status: { title: 'System Online', items: ['Ready', 'For', 'Impact'] },
  focus: {
    title: 'Current Focus',
    items: ['Advanced Java', 'System Design', 'Problem Solving', 'Building Impact'],
  },
  values: { title: 'Core Values', items: ['Create', 'Solve', 'Learn', 'Grow', 'Impact'] },
};
...
export const skills = {
  eyebrow: 'Player Loadout',
  heading: 'Technical Skills',
  supporting:
    'Equipped technologies, grouped by slot. Select an item to see where it has been deployed.',
  categories: [
    { id: 'languages', category: 'Languages', items: ['Java', 'Python', 'JavaScript', 'TypeScript', 'SQL'] },
    {
      id: 'frontend',
      category: 'Frontend',
    ...
    { id: 'tools', category: 'Tools', items: ['Git', 'GitHub', 'Docker'] },
  ],
};
...
export const journeyIntro = {
  ...
  supporting: 'Education and experience, in the order they happened.',
};
  ...
  items: [
    {
      ...
      tag: 'Internal Hackathon Selection',
      description:
  ...
  items: [
    {
      ...
      image: {
        src: '/images/certificates/frontend.png',
        aspect: '1143 / 806',
    ...
    },
    {
      ...
      image: {
        src: '/images/certificates/cloud-computing.png',
        aspect: '1157 / 807',
...
export const profile = {
  ...
  // Place the real PDF at public/resume/M-Harshavardhana-Resume.pdf, then flip
  // resumeAvailable to true. While it is false the actions stay disabled so the
  // buttons never link to a 404.
